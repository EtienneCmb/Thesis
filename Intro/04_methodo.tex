...
\todo[color=red!100]{Changer les images de LDA et SVM pour celle de naseer. Inclure dendogramme svm de Tarek et justifier le choix du LDA par rapport à la littérature ICM pour sa rapidité et sa fiabilité.}
\begin{enumerate}
...
\todo[color=orange!100]{Il faut impérativement une partie sur le deep learning}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{center} \rule{5cm}{0.2pt} \end{center}
	\end{enumerate}
	\todo[color=red!100]{Description par exemple de l'entraineur de foot et décrire les figures d'avantage}
...
\todo[color=red!100]{Inclure des figures issues de brainpipe pour montrer les différentes possibilités}
...
\begin{enumerate}
	...
	\item \textit{visbrain}: visbrain est un petit logiciel de visualisation dont le but, à terme, sera de pouvoir proposer une interface simple et modulable permettant de visualiser toute formes de signaux comme des séries temporelles, des cartes temps-fréquences... visbrain sera certainement la composante graphique de brainpipe, toujours en python. A l'heure actuelle, visbrain comprend une interface graphique pour visualiser des données dans un cerveau MNI et une autre pour visualiser des séries temporelles. Le projet débute, mais le lien suivant permet de suivre son évolution: \url{https://github.com/EtienneCmb/visbrain}
	
	\figScaleX{1}{visbrain}{Exemples de représentations possibles avec visbrain : matérialisation de sources internes, de connectivité, contrôle de la transparence/couleur pour tout les objets, projection corticales des sources internes...}
\end{enumerate}
